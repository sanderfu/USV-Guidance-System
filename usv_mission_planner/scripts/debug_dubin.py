...
def main():
    ...
    map_name = "west_coast_norway_tss"
    mission_name = "test_dubins_0"
    ...
    dubin_dir_path = rospack.get_path('usv_mission_planner')+"/data/missions/"+mission_name+"/hybrid_astar/dubin/"